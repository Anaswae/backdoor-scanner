...
|___  | || |  _ __   ___ / _ \__  __
   / /| || |_| '_ \ / __| | | \ \/ /  | Web Shell Scanner v.1.0
  / / |__   _| | | | (__| |_| |>  <   | http://github.com/soracyberteam
 /_/     |_| |_| |_|\___|\___//_/\_\  | Copyright (c) 2018 Sora Cyber Team\n\n
Usage : 74nc0x.php [dir]
Ex    : 74nc0x.php /home/soracyberteam/public_html/\n");
}elseif($argv[1]){
$dir=$argv[1];
scan($dir);
}
